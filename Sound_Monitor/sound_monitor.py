# Project 3: Sound Monitor
# Detect the sound and display the sound value on the OLED Display.
# by Tim Zhan
...
if __name__ == "__main__":
    ...
    print("The sound value is displayed on the OLED ...")
	...
	try:
	    ...
	    display.set_cursor(1, 0)
   	    display.puts('Sound Value:')
            
            display.set_cursor(3, 4)
   	    display.puts(str(sensor_value))
